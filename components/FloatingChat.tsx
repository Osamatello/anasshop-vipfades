      ...
      {open && (
        <div className="fixed inset-0 z-[60] flex items-end justify-end sm:bottom-6 sm:right-6 sm:inset-auto">
          ...
          <div className="relative z-10 flex h-[88vh] w-full flex-col sm:h-[620px] sm:w-[400px]">
            <button
              onClick={() => setOpen(false)}
              className="absolute -top-12 right-0 flex h-10 w-10 items-center justify-center rounded-full bg-brand-bgSecondary text-brand-textPrimary ring-1 ring-brand-border transition-colors hover:text-brand-accent sm:-top-1 sm:-left-12 sm:right-auto"
